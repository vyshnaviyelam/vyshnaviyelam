...
class DB_Access:
    ...
    def __init__(self):
        ...
        self.db = mysql.connector.connect(host='127.0.0.1', user="root", password="gaE3s@myu", database="network")
    ...
    def register_user(self):
        ...
        if username_info == "":
            ...
            time.sleep(0.50)
            self.success()
            logging.info("user succesfully registered")
    ...
    def registration(self):
        ...
        logging.info("user selected register")
    ...
    def login(self):
        ...
        Label(root2, text="").pack()
        logging.info("user selected login option")
    ...
    def login_varify(self):
            ...
            if results:
                for i in results:
                    self.logged()
                    logging.info("Logged succesfully")
                    self.status=True
                    break
            else:
                self.failed()
    ...
    def main_screen(self):
        ...
        Label(root, text="").pack()
        Label(root, text="").pack()
        logging.info("login portal is displayed")
        root.mainloop()
